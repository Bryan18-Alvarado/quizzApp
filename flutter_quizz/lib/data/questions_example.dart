...
List<QuestionModel> questions = [
  ...
  QuestionModel("¿Qué es la herencia?", {
  ...
  QuestionModel("¿Qué es la ecología?", {
  ...
  QuestionModel("¿Cuáles son los niveles de organización de la ecología?", {
  ...
  QuestionModel(
    "¿Qué es el ciclo del carbono?",
    {
      ...
      "El proceso de transformación del carbono en diferentes formas en el planeta":
          true,
  ...
  QuestionModel("¿Qué es un ecosistema?", {
    "Una comunidad de organismos que interactúan entre sí y con su entorno físico":
        true,
  ...
  QuestionModel("¿Qué es la biodegradación?", {
    ...
    "El proceso por el cual los organismos descomponen la materia orgánica":
        true,
    "La contaminación del medio ambiente por sustancias químicas nocivas":
        false,
  }),
  QuestionModel(
    ...
    "Por osmosis.": false,
    "dentro y fuera de la célula a través de los procesos de endocitosis y exocitosis.":
        true,
  }),
  QuestionModel("¿Qué son las bacterias?", {
    ...
    "Células procariotas unicelulares, algunas de las cuales pueden causar enfermedades":
        true,
    "Parásitos unicelulares que pueden causar enfermedades.": false,
  }),
  QuestionModel("¿Qué es ADN", {
    "Una proteína que se produce a partir de un gen.": false,
    "Una unidad de herencia que determina un rasgo.": false,
    "Una molécula que almacena la información genética.": true,
    "La forma en que se transmite la información genética de padres a hijos.":
        false,
  }),
  QuestionModel("¿Qué son las células madre?", {
    "Células con la capacidad de convertirse en diversos tipos de células":
        true,
